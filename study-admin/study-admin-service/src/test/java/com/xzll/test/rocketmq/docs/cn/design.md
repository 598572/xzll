...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_1.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_2.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_3.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_4.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_5.png)

#### 2.4 Reactor多线程设计
RocketMQ的RPC通信采用Netty组件作为底层通信库，同样也遵循了Reactor多线程模型，同时又在这之上做了一些扩展和优化。

![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_6.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_7.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_8.png)

(4) 然后，调用updateProcessQueueTableInRebalance()方法，具体的做法是，先将分配到的消息队列集合（mqSet）与processQueueTable做一个过滤比对。

![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_9.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_10.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_11.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_12.png)
...
![](hzz_main/xzll/study-test/study-admin-service/src/test/java/com/xzll/test/rocketmq/docs/cn/image/rocketmq_design_13.png)
